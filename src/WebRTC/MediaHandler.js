...
module.exports = function (SIP) {
    ...
    var MediaHandler = function (session, options) {
        ...
        this.RTCConstraints = config.RTCConstraints || {};
...
// Functions the session can use
        ...
        getDescription: {
            writable: true,
            value:    function getDescription(mediaHint, forceMethod) {
                var self = this;
        ...
        switchStream: {
            writable: true,
            value:    function (oldStream, newStream) {
                var self = this;
...
// Internal functions
        ...
        createOfferOrAnswer: {
            writable: true,
            value:    function createOfferOrAnswer(constraints, forceMethod) {
                var self = this;
                var methodName;
        ...
        toggleHoldHelper: {
            ...
            value:    function toggleHoldHelper(trackGetter, mute) {
                ...
                this.getRemoteStreams().forEach(function (stream) {
                    stream[trackGetter]().forEach(function (track) {
                        track.enabled = !mute;
                    });
                });
