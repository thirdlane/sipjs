...
util.inherits(TraceablePeerConnection, EventEmitter);
        ...
        get: function () {
            switch (prop) {
                case 'localDescription':
                    return this.peerconnection.localDescription || new RTCSessionDescription();
                case 'remoteDescription':
                    return this.peerconnection.remoteDescription || new RTCSessionDescription();
                default:
